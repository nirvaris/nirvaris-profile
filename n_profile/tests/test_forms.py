...
from ..forms import RegisterForm, ChangeUserPasswordForm, UserDetailsForm, ResendActivationEmailForm, ForgotPasswordForm, LoginForm
...
class ProfileFormsTestCase(TestCase):
    ...
    def test_change_details(self):
        ...
        form = UserDetailsForm(instance=jack_user, data=data)
        self.assertTrue(form.is_valid())
        form.save()
        ...
        form = UserDetailsForm(instance=jimmy_user, data=data)
        self.assertFalse(form.is_valid())
        ...
        form = UserDetailsForm(instance=james_user, data=data)
        self.assertFalse(form.is_valid())
